...
import sneakers from '../Shoes/Sneakers.js';
...
const Sneakers = () => {
  ...
  const [displayedsneakers, setDisplayedsneakers] = useState(sneakers);
  ...
  useEffect(() => {
    ...
    let filteredsets = filteredBrand
      ? sneakers.filter((sneaker) => sneaker.brand === filteredBrand)
      : sneakers;
    ...
    setDisplayedsneakers(filteredsets);
  ...
  return (
    ...
    <div className="row">
        ...
        <br /><br /><h1 className='pendantHead jewells liphead'>Sneakers</h1><br />
    <div className="container kurtiWrapper shirtWrapper">
       <div className="row">
          {displayedsneakers.map((sneaker, index) => (
          <div className="col-md-3 kurticol" key={index}>
            <div className="card kurticard">
              <img src={sneaker.img} className="card-img-top" alt={sneaker.name} />
              <div className="card-body kurtibody">
                 <p className="card-text lipp">{sneaker.brand}</p>
