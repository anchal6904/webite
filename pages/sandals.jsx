...
const Sandals = () => {
  ...
  const [displayedsandals, setDisplayedsandals] = useState(sandals);
  ...
  useEffect(() => {
    ...
    let filteredsets = filteredBrand
      ? sandals.filter((sandal) => sandal.brand === filteredBrand)
      : sandals;
    ...
    setDisplayedsandals(filteredsets);
  ...
  return (
    ...
    <div className="row">
        ...
        <br /><br /><h1 className='pendantHead jewells liphead'>Sandals</h1><br />
    <div className="container kurtiWrapper shirtWrapper">
       <div className="row">
          {displayedsandals.map((sandal, index) => (
