...
const Menring = () => {
  ...
  const [displayedmenrings, setDisplayedmenrings] = useState(menrings);
   ...
   useEffect(() => {
    ...
    let filteredsets = filteredBrand
      ? menrings.filter((menring) => menring.brand === filteredBrand)
      : menrings;
    ...
    setDisplayedmenrings(filteredsets);
  ...
  return (
    <div className='container'>
        <div className="row">
            ...
            <br /><br /><h1 className='pendantHead jewells liphead'>Men's Ring</h1><br />
        <div className="container kurtiWrapper shirtWrapper">
           <div className="row">
              {displayedmenrings.map((menring, index) => (
              <div className="col-md-3 kurticol" key={index}>
                <div className="card kurticard">
                  <img src={menring.img} className="card-img-top" alt={menring.name} />
                  <div className="card-body kurtibody">
                     <p className="card-text lipp">{menring.brand}</p>
