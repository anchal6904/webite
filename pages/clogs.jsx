...
import clogs from '../Shoes/clogs.js';
...
const Clogs = () => {
  ...
  const [displayedclogs, setDisplayedclogs] = useState(clogs);
  ...
  useEffect(() => {
    ...
    let filteredsets = filteredBrand
      ? clogs.filter((clog) => clog.brand === filteredBrand)
      : clogs;
    ...
    setDisplayedclogs(filteredsets);
  ...
  return (
    ...
    <div className="row">
        ...
        <br /><br /><h1 className='pendantHead jewells liphead'>Clogs</h1><br />
    <div className="container kurtiWrapper shirtWrapper">
       <div className="row">
          {displayedclogs.map((clog, index) => (
          <div className="col-md-3 kurticol" key={index}>
            <div className="card kurticard">
              <img src={clog.img} className="card-img-top" alt={clog.name} />
              <div className="card-body kurtibody">
                 <p className="card-text lipp">{clog.brand}</p>
